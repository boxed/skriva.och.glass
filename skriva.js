...
var $author$project$Skriva$linesPerPage = 5;
var $author$project$Skriva$viewLine = function (_v0) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Skriva$viewPage = function (_v0) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2(
			$elm$core$List$map,
			$author$project$Skriva$viewLine,
			A2($elm$core$List$range, 0, $author$project$Skriva$linesPerPage - 1)));
};
var $author$project$Skriva$view = function (_v0) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Skriva$viewPage,
					A2($elm$core$List$range, 0, 10)))
			]));
};
var $author$project$Skriva$main = $elm$browser$Browser$element(
	{
		at: $author$project$Skriva$init,
		az: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		aB: $author$project$Skriva$update,
		aC: $author$project$Skriva$view
	});
